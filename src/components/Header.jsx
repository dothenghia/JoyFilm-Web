                    ...
                    <div className="max-w-screen-xl mx-auto flex flex-wrap items-center justify-between">
                        ...
                        <div className="flex">
                            <div className="relative hidden md:flex mr-4">
                                ...
                                <input type="text" id="search-navbar" className="block w-full p-2 pl-4 text-md text-text rounded-lg border-none bg-black/50 placeholder:text-subheading" placeholder="Search..." />
                            </div>
