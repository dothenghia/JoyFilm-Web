        ...
        <div className="page-container-0topside">
            ...
            <div className="section-container mt-3 flex flex-col md:flex-row">
                ...
                <div className='intro-left-section px-5 md:px-0 flex flex-col justify-center'>
                    <img className='w-2/3 min-[500px]:w-1/2 md:w-[80%] rounded-xl border' alt="Screenshot (133)" src="https://i.ibb.co/7VxcPKJ/Screenshot-133.png" />
                    <img className='w-2/3 min-[500px]:w-1/2 -mt-[24%] md:w-[80%] md:-mt-[20%] rounded-xl border self-center' alt="Screenshot (134)" src="https://i.ibb.co/xDg1QcY/Screenshot-134.png" />
                    <img className='w-2/3 min-[500px]:w-1/2 -mt-[24%] md:w-[80%] md:-mt-[20%] rounded-xl border self-end' alt="Screenshot (135)" src="https://i.ibb.co/mDV81xz/Screenshot-135.png" />
                </div>
